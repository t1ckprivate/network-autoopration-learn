...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in huawei_grpc_dialout_pb2_grpc.py depends on'
...
def add_gRPCDataserviceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('huawei_dialout.gRPCDataservice', rpc_method_handlers)
